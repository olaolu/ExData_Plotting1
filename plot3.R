...
plot(datasub$Date_Time, datasub$Sub_metering_1, xaxt=NULL, xlab = "", ylab = "Energy sub metering", type="n")
## Sets up the plot, but does not populate with any data

lines(datasub$Date_Time, datasub$Sub_metering_1, col = "black", type = "S")

lines(datasub$Date_Time, datasub$Sub_metering_2, col = "red", type = "S")

lines(datasub$Date_Time, datasub$Sub_metering_3, col = "blue", type = "S")
